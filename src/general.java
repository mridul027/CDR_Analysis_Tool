...
Connection conn=null;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Phone/IMEI Search");
        ...
        jButton5.setText("ADD to Suspect List");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            String sql="Select * from "+a+" where sno="+x+" or mobile_number="+x+" or other_number="+x+" or imei="+x+" or imsi="+x+" or smsc="+x;
            pst=conn.prepareStatement(sql);
...
MessageFormat header=new MessageFormat("General Search Report");
